	...
	<div class="container">
		<div class="panel panel-default">
			...
			<div class="panel-body">
                <form class="form-horizontal" method="post" action="/geografico/car/getCarsByCityRadiusAndModel">
                    ...
                    <div class="form-group">
                        <label for="model" class="col-sm-2 col-md-2 control-label">Model</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="model" placeholder="type car model" name="model" required />
                        </div>
                    </div>                    
                    <div class="form-group">
